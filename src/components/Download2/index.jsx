...
const Download2 = () => {
  ...
  return (
    <div className='downloadwrap2' id='download2'>
      ...
      <div className='download2left'>
        <div className='download2left_text'>
          ...
          <div className='download2left_text2'>Nossas profissionais Be Glam ganham até 35% a mais do que trabalhando autônomas</div>
          <div className='download2button2'>
            Cadastrar
          </div>
        </div>
      </div>
