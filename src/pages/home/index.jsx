      ...
      <div className='homewrap'>
        <div className='homeleft'>
          <div className='lefttext'>
            ...
            <div className='who'>
              <div className='circle'><img src='/assets/images/Vector5.png' /></div>
            ...
            <div className='shape'><img src='/assets/images/Vector6.png' /></div>
          </div>
        </div>
        <div className='homeright'>
          <div>
            <div className='woman1'>
              <img src='/assets/images/woman1.png' className='girl1' />
            </div>
          </div>
        </div>
      </div>
